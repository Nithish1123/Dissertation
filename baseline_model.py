...
Original file is located at
    https://colab.research.google.com/drive/1bNbOpt6ruVvlTgsOzCngvP3vT64ULJtd
"""
...
class BaselineMLPModel(nn.Module):
    ...
    def forward(self, data):
        # Here, we directly use the node features without considering graph structure
        x = data.x
...
for params in param_combinations:
    ...
    model = BaselineMLPModel(input_dim=train_data.x.shape[1], hidden_dim=hidden_dim, dropout_rate=dropout_rate)
...
print(f"Best Hyperparameters: Hidden Dim: {best_params[0]}, Learning Rate: {best_params[1]}, Dropout Rate: {best_params[2]}")
...
# Print the baseline results in the desired format
